...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class MediaPlaylist
	{
		...
		public class MediaItem
		{
			...
			[SerializeField]
			public PlaylistMediaPlayer.Easing overrideTransitionEasing = new PlaylistMediaPlayer.Easing();
		}
	...
	public class PlaylistMediaPlayer : MediaPlayer, ITextureProducer
	{
		...
		private Easing.Preset _currentTransitionEasing = new Easing.Preset();
